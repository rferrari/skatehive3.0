...
export default function FarcasterMiniappLink({ hiveUsername, postingKey }: FarcasterMiniappLinkProps) {
    ...
    const { isInMiniapp, user, isLoading, isReady, composeCast } = useFarcasterMiniapp();
            ...
            <VStack spacing={4} align="stretch">
                <Box>
                    <Flex align="center" gap={2} mb={1}>
                        ...
                        <Badge colorScheme="purple" size="sm">MINIAPP</Badge>
                    </Flex>
                    <Text color="primary" fontSize="sm">
                        Connect your Farcaster account to receive notifications
                    </Text>
