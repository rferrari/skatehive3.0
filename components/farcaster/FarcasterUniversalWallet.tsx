...
export default function FarcasterUniversalWallet({ hiveUsername }: FarcasterUniversalWalletProps) {
            ...
            {process.env.NODE_ENV === 'development' && (
                ...
                >
                    ...
                    <VStack spacing={1} align="start">
                        ...
                        <Text fontSize="xs" color="gray.600">
                            farcasterProfile: {farcasterProfile ? `@${farcasterProfile.username}` : 'null'}
                        </Text>
                        <Text fontSize="xs" color="gray.600">
                            ...
                            <VStack spacing={3} align="start">
                                ...
                                {'custody' in farcasterProfile && farcasterProfile.custody && (
                                    <Text fontSize="xs" color="blue.400">
                                        Custody: {farcasterProfile.custody.slice(0, 6)}...{farcasterProfile.custody.slice(-4)}
                                    </Text>
                                )}
                                {hiveUsername && (
                                ...
                                >
                                    <Text fontSize="xs" color="purple.700">
                                        ...
                                        to access native wallet features and make transactions seamlessly.
                                    </Text>
                                </Box>
                            </VStack>
                        </Box>
