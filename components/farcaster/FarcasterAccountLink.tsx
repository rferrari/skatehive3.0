...
export default function FarcasterAccountLink({
  hiveUsername,
  postingKey,
}: FarcasterAccountLinkProps) {
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description:
            "Check your Farcaster notifications for a welcome message.",
        });
        await loadUserData();
            ...
            {/* {process.env.NODE_ENV === "development" && (
              <Box p={2} bg="gray.800" borderRadius="md">
                <Text fontSize="xs" color="gray.400" mb={2}>
                  ...
                  hasPersistedSession={hasPersistedSession.toString()}, profile=
                  {profile ? `${profile.username}(${profile.fid})` : "null"}
                </Text>
