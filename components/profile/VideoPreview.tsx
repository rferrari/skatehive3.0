...
export default function VideoPreview({ src, onClick }: VideoPreviewProps) {
  ...
  return (
    <Box
      ...
      width="100%"
      height="100%"
      maxWidth="100%" // Cap maximum width
      maxHeight="100%" // Cap maximum height
      cursor="pointer"
      onClick={onClick}
      _hover={{
      ...
      overflow="hidden" // Clip hover scaling
    >
      <video
        ref={videoRef}
        src={src}
        ...
        style={{
          width: "100%",
          height: "100%",
          maxWidth: "100%", // Ensure video doesn’t exceed container
          maxHeight: "100%", // Ensure video doesn’t exceed container
          objectFit: "cover",
