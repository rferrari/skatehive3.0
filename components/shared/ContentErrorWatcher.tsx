...
export const ContentErrorWatcher: React.FC<ContentErrorWatcherProps> = ({
  children,
}) => {
  ...
  useEffect(() => {
    ...
    console.warn = function (...args: any[]) {
      ...
      if (
        message.includes("@hiveio/content-renderer") &&
        (message.includes("Blocked") ||
          message.includes("does not appear to be a url"))
      ) {
