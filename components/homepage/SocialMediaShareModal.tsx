import { Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, VStack, IconButton, useClipboard, HStack, Center, ModalFooter } from '@chakra-ui/react';
...
const SocialMediaShareModal = ({ isOpen, onClose, comment }: SocialMediaShareModalProps) => {
    ...
    const handleShare = (platform: string) => {
        ...
        if (platform === 'facebook') {
            ...
            shareUrl = `https://twitter.com/intent/tweet?url=${encodeURIComponent(postLink)}`;
        } else if (platform === 'farcaster') {
            shareUrl = `https://warpcast.com/share?text=${encodeURIComponent(postLink)}`; // Hypothetical URL
        }
        if (platform !== 'copy') {
