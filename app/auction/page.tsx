      ...
      <Container maxW="6xl">
        <VStack spacing={8}>
          <VStack spacing={4} textAlign="center">
            ...
            <Text fontSize="lg" color="text" maxW="2xl" lineHeight="tall">
              Participate in our daily auctions to collect unique skateboarding
              NFTs. Each auction runs for 24 hours and features exclusive
