...
import { MdSkateboarding, MdPublic } from "react-icons/md";
import {
  validateAccountName,
  checkAccountExists,
      ...
      <Flex direction="column" align="center" justify="center" minH="100vh" px={4} position="relative" zIndex={1} mt={{ base: -3, md: -6 }}>
        ...
        >
          <VStack spacing={4} align="stretch">
            <FormControl>
              <Text fontWeight="bold" color={textColor}>Choose your Hive Username</Text>
              <Input
                type="text"
            ...
            <FormControl>
              <Text fontWeight="bold" color={textColor}>Your Email Address</Text>
              <Input
                type="email"
        ...
        <Box mt={8} w="full" maxW="3xl">
          ...
          <Flex direction={{ base: "column", md: "row" }} gap={6} justify="center">
            ...
            <FeatureCard icon={FaCheck} title="Decentralized & Secure" desc="Your data and content are yours. Powered by Hive blockchain." />
