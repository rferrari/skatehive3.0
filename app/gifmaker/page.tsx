...
const GIFMakerPage: React.FC = () => {
  ...
  return (
    <div style={{ maxWidth: 480, margin: "40px auto", padding: 24, background: "#fff", borderRadius: 12, boxShadow: "0 2px 12px rgba(0,0,0,0.08)" }}>
      <h1 style={{ fontSize: 28, fontWeight: 700, marginBottom: 16 }}>GIF Maker Utility</h1>
      ...
      <GIFMakerWithSelector ref={gifMakerWithSelectorRef} onUpload={handleUpload2} isProcessing={isProcessing2} />
      {gifUrl2 && (
        <div style={{ marginTop: 32, textAlign: "center" }}>
          <h2 style={{ fontSize: 20, fontWeight: 600, marginBottom: 12 }}>GIF Preview (Selected Segment)</h2>
          <img src={gifUrl2} alt="Generated GIF" style={{ maxWidth: "100%", borderRadius: 8, border: "1px solid #eee" }} />
          {gifSize2 !== null && (
          ...
          <div style={{ marginTop: 12 }}>
            <a href={gifUrl2} download="output.gif" style={{ color: "#0070f3", textDecoration: "underline" }}>
              Download GIF
            </a>
          </div>
        </div>
      ...
      <hr style={{ margin: "48px 0 32px 0", border: 0, borderTop: "1px solid #eee" }} />
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 16 }}>Image Compressor</h1>
      <p style={{ marginBottom: 24, color: "#555" }}>
      ...
      <ImageCompressor ref={imageCompressorRef} onUpload={handleImageUpload} isProcessing={isCompressing} />
      {compressedUrl && (
        <div style={{ marginTop: 32, textAlign: "center" }}>
          <h2 style={{ fontSize: 20, fontWeight: 600, marginBottom: 12 }}>Compressed Image Preview</h2>
          <img src={compressedUrl} alt="Compressed" style={{ maxWidth: "100%", borderRadius: 8, border: "1px solid #eee" }} />
          {compressedSize !== null && (
            <div style={{ marginTop: 8, color: "#666", fontSize: 14 }}>
          ...
          <div style={{ marginTop: 12 }}>
            <a href={compressedUrl} download="compressed-image" style={{ color: "#0070f3", textDecoration: "underline" }}>
              Download Image
            </a>
          </div>
        </div>
