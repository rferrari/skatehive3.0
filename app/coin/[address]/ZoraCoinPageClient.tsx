  ...
  return (
    <Box minH="100vh" bg="background" color="white">
      <Grid templateColumns={{ base: "1fr", lg: "1fr 400px" }} h="100vh">
        ...
        <GridItem bg="background" borderLeft="1px solid" borderColor="gray.700">
          <VStack h="100%" spacing={0}>
            {/* Header */}
            <Box w="100%" p={6} borderBottom="1px solid" borderColor="gray.700">
              <VStack align="start" spacing={3}>
                <HStack justify="space-between" w="100%">
                  <HStack>
                    <Avatar size="sm" name={coinData.name || coinData.symbol} />
            ...
            {/* Stats */}
            <Box w="100%" p={4} borderBottom="1px solid" borderColor="gray.700">
